...
public class Categoria extends EntidadeDominio {
    public static final String SAUDE = "Sade";
    public static final String EDUCACAO = "Educao";
    public static final String SEGURANCA = "Segurana";
    ...
    public static final String OCORRENCIAS = "Ocorrncias";
